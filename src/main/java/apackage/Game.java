...
public class Game extends Canvas implements Runnable {
    ...
    /*
     * Game loop to update the game and display a frames per second counter in the console
     * Called by thread.start() we created in start() method
     * Resources:
     * https://docs.oracle.com/javase/7/docs/api/java/lang/Thread.html#Thread(java.lang.Runnable)
